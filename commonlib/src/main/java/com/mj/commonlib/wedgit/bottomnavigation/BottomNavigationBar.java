package com.mj.commonlib.wedgit.bottomnavigation;
...
import com.mj.commonlib.R;
import com.mj.commonlib.utils.LogUtils;
import com.mj.commonlib.wedgit.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.mj.commonlib.wedgit.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.mj.commonlib.wedgit.bottomnavigation.utils.Utils;
...
//    }
    ...
    private void selectTabInternal(int newPosition, boolean firstTab, boolean callListener, boolean forcedSelection) {
        LogUtils.e(TAG, DEBUG, "selectTabInternal newPosition : " + newPosition + "  ;firstTab: " + firstTab + "  ;callListener : " + callListener + "  ;forcedSelection : " + forcedSelection);
        int oldPosition = mSelectedPosition;
        if (mSelectedPosition != newPosition) {
            LogUtils.e(TAG, DEBUG, " BackgroundStyle : " + mBackgroundStyle);
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
...
//                            }
    ...
    private void sendListenerCall(int oldPosition, int newPosition, boolean forcedSelection) {
        LogUtils.e(TAG, DEBUG, "sendListenerCall oldPosition :  " + oldPosition + "  ;newPosition : " + newPosition + "  ;forcedSelection : " + forcedSelection);
